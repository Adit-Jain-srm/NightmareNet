# 4. Hybrid Open-Source + Hosted Platform Model
...
Need a go-to-market strategy that builds community adoption while generating revenue.

## Decision

Apache 2.0 open-source core (distortions, training, evaluation, CLI) with proprietary hosted platform (orchestration, multi-GPU, compliance, teams).
